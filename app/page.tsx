...
import { AnimatedCtaArrow } from "@/components/animated-cta-arrow";
    ...
    <div id="top" className="min-h-screen bg-background bg-grid">
        ...
        <div className="container mx-auto px-4 py-24 md:py-32 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-8">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-150 fill-mode-backwards">
                Sistema de Seguimiento de{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-primary/80 to-primary/60 animate-gradient-text">
                  Tesis Universitarias
                </span>
              </h1>
              <p className="text-xl text-muted-foreground max-w-xl animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300 fill-mode-backwards leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-500 fill-mode-backwards">
                <Link href="/login">
                  <Button size="lg" className="gap-2 shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 w-full">
                    Iniciar Sesión <ArrowRight className="h-4 w-4" />
                  </Button>
                </Link>
                <Link href="/registrarse">
                  <Button size="lg" variant="outline" className="hover:bg-primary/5 hover:scale-[1.02] transition-all duration-300 w-full">
                    Registrarse
                  </Button>
                </Link>
              </div>
              {/* Animated arrow pointing to buttons */}
              <div className="animate-in fade-in duration-1000 delay-700 fill-mode-backwards -mt-2">
                <AnimatedCtaArrow />
              </div>

              {/* Trust indicators */}
              <div className="flex items-center gap-6 pt-4 animate-in fade-in slide-in-from-bottom-2 duration-1000 delay-700 fill-mode-backwards">
      ...
      <section className="bg-muted/50">
        <div className="container mx-auto px-4 py-16">
          ...
          >
            <div className="text-center group bg-card p-6 rounded-2xl border shadow-sm hover:shadow-lg hover:-translate-y-2 hover:border-primary/30 transition-all duration-500">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 mb-4 group-hover:bg-primary/20 group-hover:scale-110 transition-all duration-500">
      ...
      <section id="caracteristicas" className="bg-muted/50 py-24 relative">
        <div className="container mx-auto px-4">
          ...
          >
            <Card className="group hover:shadow-xl hover:border-primary/50 hover:-translate-y-2 transition-all duration-500 cursor-pointer">
              <CardHeader>
      ...
      <section id="proceso" className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          {/* Process steps with animated SVG connector */}
          <div className="relative">
            {/* Animated connector line (desktop only) */}
            <ScrollReveal animation="fade-up" className="hidden md:block absolute top-10 left-[12.5%] right-[12.5%] h-0.5 z-0">
              <svg className="w-full h-2" preserveAspectRatio="none">
                <line
                  x1="0" y1="1" x2="100%" y2="1"
                  className="stroke-primary/30 process-connector"
                  strokeWidth="2"
                />
              </svg>
            </ScrollReveal>
            ...
            >
              <div className="text-center group">
                <div className="w-20 h-20 rounded-full bg-primary text-primary-foreground flex items-center justify-center mx-auto mb-4 text-2xl font-bold shadow-lg group-hover:scale-110 group-hover:shadow-xl group-hover:shadow-primary/30 transition-all duration-500">
                  1
                </div>
      ...
      <section id="testimonios" className="bg-muted/50 py-24">
        <div className="container mx-auto px-4">
          ...
          >
            <Card className="relative hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group">
              <CardContent className="pt-6">
                <Quote className="h-8 w-8 text-primary/20 absolute top-4 right-4 group-hover:text-primary/40 transition-colors duration-500" />
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  &ldquo;La plataforma me ayudó a organizar todo el proceso de mi tesis.
                  El seguimiento con mi asesor fue mucho más fluido y pude graduarme a tiempo.&rdquo;
                </p>
            ...
            <Card className="relative hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  &ldquo;Como asesor, puedo dar seguimiento a múltiples tesistas de forma ordenada.
                  Las notificaciones y el calendario son muy útiles.&rdquo;
                </p>
                <div className="flex items-center gap-3">
                  <Avatar className="ring-2 ring-primary/10">
            ...
            <Card className="relative hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  &ldquo;Excelente sistema para gestionar los documentos y ver el progreso.
                  Recomiendo a todos los estudiantes que inicien su tesis aquí.&rdquo;
                </p>
                <div className="flex items-center gap-3">
                  <Avatar className="ring-2 ring-primary/10">
            ...
            <div className="max-w-3xl mx-auto">
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    Para registrarte, haz clic en el botón &ldquo;Registrarse&rdquo; y completa el formulario con tus datos
      ...
      <section className="bg-muted/50 py-24">
        <div className="container mx-auto px-4">
          <ScrollReveal animation="zoom-in" duration={800}>
            <Card className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground overflow-hidden relative group hover:shadow-2xl hover:shadow-primary/20 transition-all duration-700">
              ...
              <CardContent className="flex flex-col md:flex-row items-center justify-between gap-6 p-8 md:p-12 relative z-10">
                ...
                <Link href="/registrarse">
                  <Button size="lg" variant="secondary" className="shrink-0 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
